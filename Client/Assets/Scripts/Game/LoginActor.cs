...
public class LoginWindow : login_window
{
    ...
    {
        edit_account.GetComponent<InputField>().text = "wenge3";
    }
    ...
    public async Task but_start(GameObject d)
    {
        ...
        string result = await GameCommon.HttpRequest($"http://127.0.0.1:1080/?CMD=CHECK&ACCOUNT={edit_account.GetComponent<InputField>().text}&PASSWORD=999888");
