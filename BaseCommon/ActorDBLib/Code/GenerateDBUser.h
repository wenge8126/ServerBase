...
#ifndef _INCLUDE_GENERATEDBUSER_H_
#define _INCLUDE_GENERATEDBUSER_H_
...
public:
	...
	static AString generate(const AString &tableName, AutoTable table, const char *szPath, bool bConst)
	{
		...
		mCodeString.Format("// Auto generate by table tool\r\n"
			...
			"class %s : public DBUserComponent\r\n{\r\npublic:\r\n"			
			"	%s(){}\r\n\r\n"
			, name.c_str()
			, name.c_str()
			, szTableName
	...
	static  AString generateDBUser(TableMap &tableList, AString path)
	{
