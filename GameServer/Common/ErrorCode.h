...
public:
	...
	ErrorCode(int key)
	{
       AutoTable t = ErrorCode::table;
		...
		if ( t )
		{
			...
			ERROR_LOG("No exist table ErrorCode");
	}
	...
	ErrorCode(bool bNewGrowth) { if (bNewGrowth) GrowthNew(); }
