...
#ifndef _DBUSER_T_USER_H_
#define _DBUSER_T_USER_H_

#include "DBUserComponent.h" 

class DBUser_t_user : public DBUserComponent
{
public:
	DBUser_t_user(){}

    virtual const char* GetTableName() const override { return "t_user"; }
	...
	Data DATA_ID(/*INT64*/) { if (mDataRecord) return mDataRecord->get(7); ERROR_LOG("No exist record %s", mKey.c_str()); return Data(); }
	...
	Int64 wDATA_ID() const { Int64 v = 0; if (mDataRecord) {  mDataRecord->get(7, v); return v; } ERROR_LOG("No exist record %s", mKey.c_str()); return v; }
    ...
    bool SetDATA_ID(Int64 nVal) { if (!mDataRecord) return false; return mDataRecord->set(7, nVal); }


	virtual bool CheckTable(AutoTable t) override
	{
		AutoField f = t->GetField();
		if (!f || !f->CheckSame(1868918835))
		{
		...
		fieldNameList[0] = "DBID"; fieldNameList[1] = "PHONE"; fieldNameList[2] = "INVITE_CODE"; fieldNameList[3] = "INTRODUCER"; fieldNameList[4] = "REGISTER_TIME"; fieldNameList[5] = "USERDATA"; fieldNameList[6] = "MD5"; fieldNameList[7] = "DATA_ID"; 
