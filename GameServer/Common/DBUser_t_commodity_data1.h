...
#ifndef _DBUSER_T_COMMODITY_DATA1_H_
#define _DBUSER_T_COMMODITY_DATA1_H_

#include "DBUserComponent.h" 

class DBUser_t_commodity_data1 : public DBUserComponent
{
public:
	DBUser_t_commodity_data1(){}

    virtual const char* GetTableName() const override { return "t_commodity_data1"; }
