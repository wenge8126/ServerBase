...
int main()
{
	...
	INIT_RUN_CONFIG(ShareDBConfig, "share_db_config")

	logFileName.Format("./Log/%s_%4d-%02d-%02d_%02d-%02d-%02d.log", ShareSQLThread::GetAppName()
		, nowtime.wYear, nowtime.wMonth, nowtime.wDay, nowtime.wHour, nowtime.wMinute, nowtime.wSecond);

	TableTool::SetLog(new TableLog(logFileName.c_str()));

	logErrorFileName.Format("./Error/%s_Error_%4d-%02d-%02d_%02d-%02d-%02d.log.log", ShareSQLThread::GetAppName()
		, nowtime.wYear, nowtime.wMonth, nowtime.wDay, nowtime.wHour, nowtime.wMinute, nowtime.wSecond);

	Allot::setLogFile(ShareSQLThread::GetAppName());
	...
	ShareSQLThread *pThread = MEM_NEW ShareSQLThread();
