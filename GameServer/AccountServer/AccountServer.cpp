...
int main()
{
	...
	logFileName.Format("./Log/%s_%4d-%02d-%02d_%02d-%02d-%02d.log", AccountThread::GetAppName(),
		nowtime.wYear, nowtime.wMonth, nowtime.wDay, nowtime.wHour, nowtime.wMinute, nowtime.wSecond);

	TableTool::SetLog(new TableLog(logFileName.c_str()));

	logErrorFileName.Format("./Error/%s_Error_%4d-%02d-%02d_%02d-%02d-%02d.log", AccountThread::GetAppName(),
		nowtime.wYear, nowtime.wMonth, nowtime.wDay, nowtime.wHour, nowtime.wMinute, nowtime.wSecond);

	Allot::setLogFile(AccountThread::GetAppName());
	...
	AccountThread *gpThread = MEM_NEW AccountThread();
	mServer->Start(gpThread, AccountThread::GetAppName(), logFileName.c_str(), NULL);
